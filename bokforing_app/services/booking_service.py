...
def process_bilaga_upload(file, company_id, base_upload_path):
    ...
    if parsed_data:
        # Сохраняем "сырые" строковые значения
        new_bilaga.fakturanr = parsed_data.get('fakturanr')
        new_bilaga.ocr = parsed_data.get('ocr')
        new_bilaga.total_netto = parsed_data.get('total_netto')
        new_bilaga.total_moms = parsed_data.get('total_moms')
        new_bilaga.total_brutto = parsed_data.get('total_brutto')
        new_bilaga.att_betala = parsed_data.get('att_betala')

        # Конвертируем и сохраняем числовые значения
        ...
        new_bilaga.saljare_momsregnr = saljare.get('momsregnr')
...
def update_bilaga_metadata_service(bilaga_id, data):
    ...
    bilaga.saljare_momsregnr = data.get('saljare_momsregnr')
    ...
    bilaga.kund_adress = data.get('kund_adress')

    bilaga.total_netto = data.get('total_netto')
    bilaga.total_moms = data.get('total_moms')
    bilaga.total_brutto = data.get('total_brutto')
    bilaga.att_betala = data.get('att_betala')
